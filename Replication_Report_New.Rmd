...
The paper is called "The Superiority of Economists". We deduced the main thesis: Economists see themselves at the top of social science. The four independent variabels include: insularity, hierarchy, reorientation towards business, and other differentiators.
...
Regarding the method, we noticed that the authors did not develop or refer to any theoretical background. We are not sure if this is compatible with a scientific ethos of an deductive approach. We also realized, that the authors came up with strong normative claims evolved from simple descriptive statistics. Therefore, we critize their aggressive claims which are partly not in line with the use of simple descriptives. This bad balance between descriptive and normative claims is also a result from the unclear formulation of their main thesis. After reading the paper several times we still asked ourselves: what is the actual purpose of the paper? Is it simply describing the shifting relationships and the general relationship of the different social sciences? But again, how does that fit together with their normative claim that economists see themselves as a superior class. Our main ciritic of the independent variables are the follwoing:
 ...
 + Hierarchy: Not a good measure to proove superiority of economists because indicates nothing related to their claim of economists seeing   
   themselves as superior. This desciptive analysis does not lead to causal explanation of the dependent variable. Hierarchy itself is a  
   differentiator but not clear evidence that economists see themselves as a suerior class. 
 + Reorientation to business and finance is not a good indicator for their main thesis.
 + Other differentiators: There are differentiators which are suitable for their claims: evidence for selfishness, more income, higher 
   self-confidence, strong world-view/norms, unusual power of economists in the real world, successful rational choice theory (adapted from  
   other social sciences), etc. However, the authors did not manage to proove causal inference for these differentiators.
 
In our view, the authors do not really provide enough evidence to back-up their strong claim. Especially by evaluating the operationalization of their 4 independant variables it becomes clear that the authors suceed in pointing out differences between the discipline of economics and other social sciences but do not fully suceed in explaining their normative claims. Descriptives might be a good fit to draw lines and show differences between disciplines but certainly not the right method to support their thesis and normative claims. That's why we criticize the authors overshooting of descriptives. From a logical standpoint the paper could be prone to the naturlistic fellacy as they deduce normative claims from a descriptive base.
